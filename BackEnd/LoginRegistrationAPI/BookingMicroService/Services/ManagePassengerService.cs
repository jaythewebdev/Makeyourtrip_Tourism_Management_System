...
{
    public class ManagePassengerService : IManagePassenger
    {
        private readonly IBaseCRUD<int, Passenger> _passengerRepo;
        private readonly ILogger<ManagePassengerService> _logger;

        public ManagePassengerService(IBaseCRUD<int, Passenger> passengerRepo, ILogger<ManagePassengerService> logger)
        {
